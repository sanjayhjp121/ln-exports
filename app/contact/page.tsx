    ...
    <div className="bg-stone-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <a href={`mailto:${CONTACT.email}`} className="flex items-start gap-3 group">
                  <div className="w-10 h-10 rounded-full bg-red-50 border border-red-200 flex items-center justify-center flex-shrink-0 group-hover:bg-red-100 transition-colors mt-0.5">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-stone-700 group-hover:text-[#8B1515] transition-colors">
                      {CONTACT.email}
                    </div>
                  </div>
                </a>
              ...
              <ol className="space-y-2.5 text-sm text-stone-600">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#1B2A5E] text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                      {i + 1}
                    </span>
                    {step}
                  </li>
          ...
          {/* Enquiry form */}
          <div className="lg:col-span-3 bg-white rounded-2xl border border-stone-100 shadow-sm p-8 border-t-4 border-t-[#8B1515]">
